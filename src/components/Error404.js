    ...
    return (
        <div className='bg-landing-background bg-cover h-screen grid grid-cols-2 font-roboto'>
            ...
            <div className='flex flex-col items-center my-auto text-center'>
                ...
                <button className='bg-green-600 hover:bg-green-800 text-white font-medium text-sm shadow-lg hover:shadow-none transition-all px-4 py-1 rounded-md mt-2' onClick={() => navigate('/')}>Return to Home</button>
            </div>
        </div>
    )
}
