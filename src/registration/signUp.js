        ...
        <div className='bg-landing-background bg-cover h-screen grid grid-cols-2 font-roboto'>
            ...
            <div className='flex flex-col items-center my-auto text-center'>
                ...
                <div className='flex flex-col'>
                    <input type="text" className='bg-white w-80 px-4 py-2 rounded-full my-4' placeholder='Name' />
                    <input type="text" className='bg-white w-80 px-4 py-2 rounded-full mb-4' placeholder='Email' />
                    <input type="text" className='bg-white w-80 px-4 py-2 rounded-full mb-4' placeholder='Password' />
                    <input type="text" className='bg-white w-80 px-4 py-2 rounded-full mb-4' placeholder='Confirm Password' />
                    <input type="text" className='bg-white w-80 px-4 py-2 rounded-full mb-4' placeholder='College Id' />
                    <input type="text" className='bg-white w-80 px-4 py-2 rounded-full mb-4' placeholder='Gender' />
