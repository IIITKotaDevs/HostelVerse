        ...
        <div className='px-16 py-10 bg-dashboard bg-cover h-screen'>
            ...
            <div className='mt-16 flex items-center gap-8'>
                ...
                <div className='flex flex-col gap-1'>
                    ...
                    <p className='text-gray-800 font-medium text-xl'>Have a good day !!!</p>
                </div>
            </div>
            <div className='flex gap-8 mt-8'>
                {data.map((item, index) => (
                    <div className='text-center bg-primary2 p-6 rounded'>
                        <p className='text-sm'>{item.title}</p>
                        <p className='font-bold italic font-nunito text-3xl'>{item.value}</p>
                    </div>
                ))}
            </div>
        </div>
